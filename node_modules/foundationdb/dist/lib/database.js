...
class Database {
    ...
    at(prefixOrSubspace, keyXf, valueXf) {
        if (subspace_1.isGetSubspace(prefixOrSubspace))
    ...
    withKeyEncoding(keyXf = transformer_1.defaultTransformer) {
    ...
    rawCreateTransaction(opts) {
        return new transaction_1.default(this._db.createTransaction(), false, this.subspace, opts);
    }
    get(key) {
