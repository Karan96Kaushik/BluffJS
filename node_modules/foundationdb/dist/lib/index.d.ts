...
export declare const util: {
    strInc: (val: fdb.NativeValue) => Buffer;
};
...
export declare const createCluster: (clusterFile?: string | undefined) => Promise<{
    openDatabase(dbName?: 'DB', opts?: DatabaseOptions | undefined): Promise<Database<fdb.NativeValue, Buffer, fdb.NativeValue, Buffer>>;
    openDatabaseSync(dbName?: 'DB', opts?: DatabaseOptions | undefined): Database<fdb.NativeValue, Buffer, fdb.NativeValue, Buffer>;
    close(): void;
}>;
/** @deprecated FDB clusters have been removed from the API. Call open() directly to connect. */
export declare const createClusterSync: (clusterFile?: string | undefined) => {
    openDatabase(dbName?: 'DB', opts?: DatabaseOptions | undefined): Promise<Database<fdb.NativeValue, Buffer, fdb.NativeValue, Buffer>>;
    openDatabaseSync(dbName?: 'DB', opts?: DatabaseOptions | undefined): Database<fdb.NativeValue, Buffer, fdb.NativeValue, Buffer>;
    close(): void;
};
