...
export declare type KVList<Key, Value> = {
    results: [Key, Value][];
    more: boolean;
};
export { Watch };
...
export default class Transaction<KeyIn = NativeValue, KeyOut = Buffer, ValIn = NativeValue, ValOut = Buffer> {
    ...
    */
     ...
     */
    getRangeBatch(_start: KeyIn | KeySelector<KeyIn>, // Consider also supporting string / buffers for these.
    _end?: KeyIn | KeySelector<KeyIn>, // If not specified, start is used as a prefix.
    opts?: RangeOptions): AsyncGenerator<[KeyOut, ValOut][], void, unknown>;
    /**
     ...
     *   opts.
     */
    getRange(start: KeyIn | KeySelector<KeyIn>, // Consider also supporting string / buffers for these.
    end?: KeyIn | KeySelector<KeyIn>, opts?: RangeOptions): AsyncGenerator<[KeyOut, ValOut], void, unknown>;
    /**
     ...
     */
    getRangeAll(start: KeyIn | KeySelector<KeyIn>, end?: KeyIn | KeySelector<KeyIn>, // if undefined, start is used as a prefix.
    opts?: RangeOptions): Promise<[KeyOut, ValOut][]>;
     ...
     * *start* as a prefix.
     */
    clearRange(_start: KeyIn, _end?: KeyIn): void;
