...
const prefixTransformer = (prefix, inner) => {
    ...
    const transformer = {
        ...
        pack(v) {
            ...
            return util_1.concat2(_prefix, util_1.asBuf(innerVal));
        },
        unpack(buf) {
            if (!util_1.startsWith(buf, _prefix))
    ...
    if (inner.packUnboundVersionstamp)
        transformer.packUnboundVersionstamp = (val) => {
            ...
            return {
                data: util_1.concat2(_prefix, innerVal.data),
    ...
    if (inner.range)
        transformer.range = prefix => {
            ...
            return {
                begin: util_1.concat2(_prefix, util_1.asBuf(innerRange.begin)),
                end: util_1.concat2(_prefix, util_1.asBuf(innerRange.end)),
            };
        };
    return transformer;
};
